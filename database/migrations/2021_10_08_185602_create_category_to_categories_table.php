...
class CreateCategoryToCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('category_to_categories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('category_to_categories');
    }
}
